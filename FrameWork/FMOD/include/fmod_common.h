...
#define FMOD_VERSION    0x00011004
...
typedef void (F_CALLBACK *FMOD_FILE_ASYNCDONE_FUNC)           (FMOD_ASYNCREADINFO *info, FMOD_RESULT mResult);
...
typedef struct
{
    FMOD_RESULT                      mResult;                     /* Error code result */
...
typedef FMOD_RESULT (F_CALLBACK *FMOD_SOUND_NONBLOCK_CALLBACK)  (FMOD_SOUND *sound, FMOD_RESULT mResult);
